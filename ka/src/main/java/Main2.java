...
//        String wid = res.substring(92, 124);
        ...
        RequestBody body2 = RequestBody.create(mediaType2, "WID="+wid+"&NEED_CHECKIN_DATE="+s+"&DEPT_CODE=1008&CZR=&CZZXM=&CZRQ="+s+" 00:00:00&USER_ID=201922080813&USER_NAME=孙海鹏&DEPT_NAME=计算机科学与工程学院（网络空间安全学院）&GENDER_CODE=男&AGE=23&PHONE_NUMBER=18428071278&IDCARD_NO=410122199708250090&LB=全日制专业硕士&PERSON_TYPE_DISPLAY=留校&PERSON_TYPE=001&TUTOR=吴立军&LOCATION_PROVINCE_CODE_DISPLAY=四川省&LOCATION_PROVINCE_CODE=510000&LOCATION_CITY_CODE_DISPLAY=成都市&LOCATION_CITY_CODE=510100&LOCATION_COUNTY_CODE_DISPLAY=郫都区&LOCATION_COUNTY_CODE=510117&LOCATION_DETAIL=电子科技大学清水河校区&HEALTH_STATUS_CODE_DISPLAY=正常&HEALTH_STATUS_CODE=001&HEALTH_UNSUAL_CODE=&IS_HOT_DISPLAY=否&IS_HOT=0&IS_IN_HB_DISPLAY= 否&IS_IN_HB= 否&IS_HB_BACK_DISPLAY= 否&IS_HB_BACK= 否&IS_DEFINITE_DISPLAY= 否&IS_DEFINITE= 否&IS_QUARANTINE_DISPLAY= 否&IS_QUARANTINE= 否&IS_KEEP_DISPLAY= 否&IS_KEEP= 否&TEMPERATURE= &IS_SEE_DOCTOR_DISPLAY= 否&IS_SEE_DOCTOR=否&IS_IN_SCHOOL_DISPLAY= 是&IS_IN_SCHOOL= 是&MEMBER_HEALTH_STATUS_CODE_DISPLAY=正常&MEMBER_HEALTH_STATUS_CODE=正常&MEMBER_HEALTH_UNSUAL_CODE_DISPLAY= &MEMBER_HEALTH_UNSUAL_CODE= &REMARK= &CREATED_AT= "+s+" 11:15&SAW_DOCTOR_DESC=");
